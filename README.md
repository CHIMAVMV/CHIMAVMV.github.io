...
<body>
    ...
    <div id="lead">
        <div id="lead-content">
            <h1>Nweke Chima Gideon</h1>
            <h2>Software Engineer</h2>
            <a href="./" download class="btn-rounded-white">Download Resume</a>
        </div>
        <!-- End #lead-content -->
    ...
    <div id="education">
        ...
        <div class="education-block">
            ...
            <span class="education-date">Sept 2016 - Sept 2019</span>
        ...
        <div class="education-block">
            ...
            <span class="education-date">Sept 2022 - Sept 2023</span>
